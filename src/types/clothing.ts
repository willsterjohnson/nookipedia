 ...
 */
export type Category = "Tops" | "Bottoms" | "Dress-up" | "Headwear" | "Accessories" | "Socks" | "Shoes" | "Bags" | "Umbrellas";
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type Style = "Active" | "Cool" | "Cute" | "Elegant" | "Gorgeous" | "Simple";
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type FilterExcludeDetails = FilterMany & {
  /**
   * Exclude information.
   *
