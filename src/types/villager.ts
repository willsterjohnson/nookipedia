 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type GameActual = "DNM" | "AC" | "E_PLUS" | "WW" | "CF" | "NL" | "WA" | "NH" | "FILM" | "HHD" | "PC";
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type Game = GameActual | GameAlt;
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type SchemaNHDetails = Schema & {
  nh_details: {
    /**
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type FilterExcludeDetails = Filter & {
  /**
 ...
 * @author Will 'Willster' Johnson (@willster277)
 */
export type FilterNHDetails = Filter & {
  /**
   * Retrive New Horizons info.
   *
   * When set to true, an nh_details object will be included that contains New Horizons details about the villager.
